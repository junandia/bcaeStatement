...
def mainBcaEstatement():
    ...
    if uploaded_files:
        ...
        for uploaded_file in uploaded_files:
            ...
            header_dataframe = tabula.read_pdf(file_path, area=(70, 315, 141, 548), pages='1', pandas_options={'header': None, 'dtype': str}, force_subprocess=True)[0]
            ...
            dataframes = tabula.read_pdf(file_path, area=(231, 25, 797, 577), columns=[86, 184, 300, 340, 467], pages='all', pandas_options={'header': None, 'dtype': str}, force_subprocess=True)
